...
def encontrar_contornos(edges_blur):
...
# Carregando a imagem
img = carregar_imagem('images/Satelite.jpeg')
...
edges_gray = detectar_bordas(img_gray, threshold1=0, threshold2=200)
edges_blur = detectar_bordas(img_blur, threshold1=150, threshold2=600)

# Encontrando contornos na imagem thresholded
contours = encontrar_contornos(edges_blur)
...
# Exibindo apenas a imagem final com os contornos destacados
